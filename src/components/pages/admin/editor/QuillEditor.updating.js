...
class QuillEditor extends React.Component {
    ...
    insertImage = (e) => {
      ...
      if (e.currentTarget && e.currentTarget.files && e.currentTarget.files.length > 0) {
        ...
        formData.append('urlToImage', file);

        axios.post('http://localhost:5000/api/v2/upload', formData, config)
          .then((response) => {
            if (response.status == 201) {
              ...
              quill.insertEmbed(position, 'image', { src: `http://localhost:5000/${response.data.data.urltoimage}`, alt: 'image' });
        ...
        axios.post('http://localhost:5000/api/v2/upload', formData, config)
          .then((response) => {
            if (response.status == 201) {
              ...
              let range = quill.getSelection();
              let position = range ? range.index : 0;
              quill.insertEmbed(position, 'video', { src: `http://localhost:5000/${response.data.data.urltoimage}`, title: 'video' });
              quill.setSelection(position + 1);
    ...
    render() {
      return (
            <div>
                <div style={{ backgroundColor: 'white', position: 'sticky', top: 0, zIndex: 1 }} id="toolbar">
                    ...
                    <button class="ql-list" value="bullet" type="button"><svg viewBox="0 0 18 18"> <line class="ql-stroke" x1="6" x2="15" y1="4" y2="4"></line> <line class="ql-stroke" x1="6" x2="15" y1="9" y2="9"></line> <line class="ql-stroke" x1="6" x2="15" y1="14" y2="14"></line> <line class="ql-stroke" x1="3" x2="3" y1="4" y2="4"></line> <line class="ql-stroke" x1="3" x2="3" y1="9" y2="9"></line> <line class="ql-stroke" x1="3" x2="3" y1="14" y2="14"></line> </svg></button>                    <button className="ql-insertImage">
                    <i style={{ fontSize: '1.1rem' }} class="material-icons">photo</i>
                    </button>
    ...
    formats = [
      ...
      'image', 'video', 'file', 'link', 'code-block', 'video', 'blockquote', 'clean', 'list', 'bullet', 'align',
    ];
}
